...
#line 175 "./syntax.tab.c" /* yacc.c:355  */
};
...
{
       0,    76,    76,    97,    98,   103,   104,   106,   107,   108,
     109,   110,   111,   112,   115,   121,   125,   128,   142,   143,
     146,   147,   150,   153,   157,   158,   161,   162,   163,   168,
     174,   179,   180,   183,   186,   187,   190,   194,   195,   198,
     201,   204,   205,   206,   209,   213,   218,   221,   224,   229,
     230,   231,   232,   233,   235,   240,   242,   245,   246,   249,
     250,   254,   259,   261,   262,   263,   264,   265,   266,   267,
     268,   269,   271,   273,   275,   276,   278,   280,   281,   282,
     283
};
#endif
...
static const char *const yytname[] =
{
  ...
  "ConstructorDec", "ConstructorId", "TypeIdList", "TypeId",
  "PatternMatching", "PatternMatchingParamList", "Specifier", "VarDef",
  "DecList", "Dec", "VarDec", "Exp", YY_NULLPTR
};
#endif
...
{
     131,   -27,   -23,     7,  -104,  -104,     3,    12,   169,   169,
    -104,  -104,  -104,    17,    22,   169,  -104,     9,   131,    20,
    -104,   131,  -104,  -104,    28,  -104,  -104,  -104,  -104,  -104,
      19,  -104,  -104,     0,    38,  -104,   278,   169,    93,    64,
      44,    68,    48,     8,    55,   169,   169,   299,  -104,    75,
      61,    73,     0,   194,    51,  -104,  -104,  -104,    68,  -104,
     169,  -104,    77,    98,  -104,   169,   169,   169,   169,   169,
     169,   169,   169,  -104,    82,    66,   216,    58,   225,  -104,
    -104,    64,    91,    94,     4,  -104,   106,   169,   247,   256,
    -104,    44,   114,    44,  -104,  -104,  -104,  -104,    97,   111,
     185,   121,   169,   329,   336,   353,   345,    55,    55,     8,
       8,  -104,   105,  -104,   104,   320,  -104,  -104,  -104,  -104,
      44,  -104,    44,   106,   106,   108,   131,   131,   109,    44,
    -104,    68,   111,  -104,   111,  -104,  -104,   329,   159,  -104,
     159,  -104,  -104,  -104,   132,   119,  -104,   109,  -104,  -104,
    -104,  -104,  -104,   121,   131,  -104,  -104
};
...
{
       4,     0,     0,     0,    61,    44,     0,    50,     0,     0,
      49,    78,    79,     0,     0,     0,    13,     0,     4,     0,
       2,     4,     8,    54,     0,    80,    73,    52,    53,     7,
       0,    51,    56,     0,     0,    77,     0,     0,     0,    35,
       0,     0,     0,    66,    71,     0,     0,     0,    50,     0,
       0,    21,     0,     0,     0,     1,     3,    23,     0,    31,
       0,    55,    57,    59,     6,     0,     0,     0,     0,     0,
       0,     0,     0,     5,     0,     0,     0,     0,     0,    36,
      33,    35,     0,     0,    16,    40,    48,     0,     0,     0,
       9,     0,     0,     0,    22,    72,    14,    32,     0,    43,
       0,     0,     0,    62,    63,    64,    65,    67,    68,    69,
      70,    76,     0,    24,     0,    28,    75,    30,    74,    34,
       0,    17,     0,    48,    48,     0,     0,     0,    19,     0,
      20,    37,    43,    39,    43,    29,    58,    60,     0,    25,
       0,    15,    47,    46,     0,    10,    12,    18,    38,    42,
      41,    27,    26,     0,     0,    45,    11
};
...
{
    -104,  -104,    -7,  -103,   123,    27,  -104,  -104,    59,  -104,
    -104,  -104,   -94,  -104,  -104,  -104,  -104,    70,   -34,    23,
    -104,   117,   -50,    -1,  -104,    -2,   -13,  -104,    69,  -104,
     -30,    -8
};
...
{
      -1,    19,    20,    21,    22,    83,    23,    24,    50,    51,
      25,    26,   114,    27,    28,    29,    30,    80,   132,    97,
      98,    99,   133,    31,    32,   125,    33,    34,    61,    62,
      35,    36
};
...
{
      43,    44,    39,    63,    52,    81,    37,    47,     4,    53,
      38,    54,     1,     2,    56,   122,     5,     4,     5,     6,
      55,    48,    94,   145,   146,    77,     8,    84,     9,    76,
      78,    10,    58,    11,    12,    60,    40,    88,    89,    60,
      74,    75,    17,    49,   151,    41,   152,    81,    82,    59,
      45,   156,   100,     5,     6,    46,    48,   103,   104,   105,
     106,   107,   108,   109,   110,    18,    10,   115,    64,     1,
      42,    63,    79,   112,     4,    71,    72,    85,   128,    78,
      52,    87,   149,     8,   150,     9,    91,    74,    75,    96,
      11,    12,   117,    60,   137,    92,     1,     2,   134,    17,
     113,     4,     5,     6,    93,    48,   111,    77,   101,    84,
       8,   102,     9,   123,   124,    10,   147,    11,    12,    79,
       5,   142,   143,   155,   120,   129,    17,   131,   121,     4,
     115,   134,   115,   134,     1,     2,   138,     3,   139,     4,
       5,     6,   144,     7,    60,   153,   154,    57,     8,   141,
       9,   119,   130,    10,   148,    11,    12,    13,    86,    14,
      15,    16,     1,    42,    17,     0,   112,     4,    18,     0,
     136,     0,     1,    42,     0,     0,     8,     4,     9,     0,
       0,     0,     0,    11,    12,     0,     8,     0,     9,     0,
       0,     0,    17,    11,    12,     0,     0,     0,    65,    66,
      67,    68,    17,    69,    70,    71,    72,    65,    66,    67,
      68,     0,    69,    70,    71,    72,     0,    74,    75,     0,
       0,   135,     0,     0,     0,     0,    74,    75,    95,    65,
      66,    67,    68,     0,    69,    70,    71,    72,    65,    66,
      67,    68,     0,    69,    70,    71,    72,     0,    74,    75,
     116,     0,     0,     0,     0,     0,     0,    74,    75,   118,
      65,    66,    67,    68,     0,    69,    70,    71,    72,    65,
      66,    67,    68,     0,    69,    70,    71,    72,     0,    74,
      75,   126,     0,     0,     0,     0,     0,     0,    74,    75,
     127,    65,    66,    67,    68,     0,    69,    70,    71,    72,
       0,     0,     0,     0,     0,     0,     0,     0,    73,     0,
      74,    75,    65,    66,    67,    68,     0,    69,    70,    71,
      72,     0,     0,     0,     0,     0,     0,     0,     0,    90,
       0,    74,    75,    65,    66,    67,    68,     0,    69,    70,
      71,    72,    65,    66,    67,    68,     0,    69,    70,    71,
      72,   140,    74,    75,    69,    70,    71,    72,     0,    66,
      67,    74,    75,    69,    70,    71,    72,    66,    74,    75,
       0,    69,    70,    71,    72,     0,     0,    74,    75,     0,
       0,     0,     0,     0,     0,    74,    75
};

static const yytype_int16 yycheck[] =
{
       8,     9,     3,    33,    17,    39,    33,    15,     8,    17,
      33,    18,     3,     4,    21,    11,     9,     8,     9,    10,
       0,    12,    52,   126,   127,    38,    17,    40,    19,    37,
      38,    22,    13,    24,    25,    35,    33,    45,    46,    35,
      32,    33,    33,    34,   138,    33,   140,    81,     4,    30,
      33,   154,    60,     9,    10,    33,    12,    65,    66,    67,
      68,    69,    70,    71,    72,    37,    22,    75,    30,     3,
       4,   101,     8,     7,     8,    20,    21,     9,    91,    87,
      93,    33,   132,    17,   134,    19,    11,    32,    33,    38,
      24,    25,    34,    35,   102,    34,     3,     4,    99,    33,
      34,     8,     9,    10,    31,    12,    24,   120,    31,   122,
      17,    13,    19,     7,     8,    22,   129,    24,    25,     8,
       9,   123,   124,   153,    33,    11,    33,    30,    34,     8,
     138,   132,   140,   134,     3,     4,    31,     6,    34,     8,
       9,    10,    34,    12,    35,    13,    27,    24,    17,   122,
      19,    81,    93,    22,   131,    24,    25,    26,    41,    28,
      29,    30,     3,     4,    33,    -1,     7,     8,    37,    -1,
     101,    -1,     3,     4,    -1,    -1,    17,     8,    19,    -1,
      -1,    -1,    -1,    24,    25,    -1,    17,    -1,    19,    -1,
      -1,    -1,    33,    24,    25,    -1,    -1,    -1,    13,    14,
      15,    16,    33,    18,    19,    20,    21,    13,    14,    15,
      16,    -1,    18,    19,    20,    21,    -1,    32,    33,    -1,
      -1,    36,    -1,    -1,    -1,    -1,    32,    33,    34,    13,
      14,    15,    16,    -1,    18,    19,    20,    21,    13,    14,
      15,    16,    -1,    18,    19,    20,    21,    -1,    32,    33,
      34,    -1,    -1,    -1,    -1,    -1,    -1,    32,    33,    34,
      13,    14,    15,    16,    -1,    18,    19,    20,    21,    13,
      14,    15,    16,    -1,    18,    19,    20,    21,    -1,    32,
      33,    34,    -1,    -1,    -1,    -1,    -1,    -1,    32,    33,
      34,    13,    14,    15,    16,    -1,    18,    19,    20,    21,
      -1,    -1,    -1,    -1,    -1,    -1,    -1,    -1,    30,    -1,
      32,    33,    13,    14,    15,    16,    -1,    18,    19,    20,
      21,    -1,    -1,    -1,    -1,    -1,    -1,    -1,    -1,    30,
      -1,    32,    33,    13,    14,    15,    16,    -1,    18,    19,
      20,    21,    13,    14,    15,    16,    -1,    18,    19,    20,
      21,    31,    32,    33,    18,    19,    20,    21,    -1,    14,
      15,    32,    33,    18,    19,    20,    21,    14,    32,    33,
      -1,    18,    19,    20,    21,    -1,    -1,    32,    33,    -1,
      -1,    -1,    -1,    -1,    -1,    32,    33
};
...
static const yytype_uint8 yystos[] =
{
      ...
      59,    66,    67,    69,    70,    73,    74,    33,    33,    66,
      33,    33,     4,    74,    74,    33,    33,    74,    12,    34,
      51,    52,    69,    74,    45,     0,    45,    47,    13,    30,
      35,    71,    72,    73,    30,    13,    14,    15,    16,    18,
      19,    20,    21,    30,    32,    33,    74,    69,    74,     8,
      60,    61,     4,    48,    69,     9,    64,    33,    74,    74,
      30,    11,    34,    31,    73,    34,    38,    62,    63,    64,
      74,    31,    13,    74,    74,    74,    74,    74,    74,    74,
      74,    24,     7,    34,    55,    74,    34,    34,    34,    60,
      33,    34,    11,     7,     8,    68,    34,    34,    69,    11,
      51,    30,    61,    65,    66,    36,    71,    74,    31,    34,
      31,    48,    68,    68,    34,    46,    46,    69,    62,    65,
      65,    55,    55,    13,    27,    73,    46
};
...
#line 106 "./syntax.y" /* yacc.c:1646  */
    { (yyval.type_node) = new_parent_node("Stmt", GROUP_3 + 3, 1, (yyvsp[0].type_node)); }
...
#line 179 "./syntax.y" /* yacc.c:1646  */
    { (yyval.type_node) = new_parent_node("ADTRef", GROUP_7 + 1, 1, (yyvsp[-1].type_node)); }
#line 1735 "./syntax.tab.c" /* yacc.c:1646  */
    break;

  case 32:
#line 180 "./syntax.y" /* yacc.c:1646  */
    { (yyval.type_node) = new_parent_node("ADTHeader", GROUP_7 + 2, 2, (yyvsp[-2].type_node), (yyvsp[0].type_node)); }
...
#line 194 "./syntax.y" /* yacc.c:1646  */
    { (yyval.type_node) = new_parent_node("ConstructorDecList", GROUP_7 + 7, 1, (yyvsp[-1].type_node)); }
#line 1771 "./syntax.tab.c" /* yacc.c:1646  */
    break;

  case 38:
#line 195 "./syntax.y" /* yacc.c:1646  */
    { (yyval.type_node) = new_parent_node("ConstructorDecList", GROUP_7 + 8, 2, (yyvsp[-2].type_node), (yyvsp[0].type_node)); }
...
#line 204 "./syntax.y" /* yacc.c:1646  */
    { (yyval.type_node) = new_parent_node("TypeIdList", GROUP_7 + 11, 2, (yyvsp[-1].type_node), (yyvsp[0].type_node)); }
#line 1795 "./syntax.tab.c" /* yacc.c:1646  */
    break;

  case 42:
#line 205 "./syntax.y" /* yacc.c:1646  */
    { (yyval.type_node) = new_parent_node("TypeIdList", GROUP_7 + 12, 2, (yyvsp[-1].type_node), (yyvsp[0].type_node)); }
#line 1801 "./syntax.tab.c" /* yacc.c:1646  */
    break;

  case 43:
#line 206 "./syntax.y" /* yacc.c:1646  */
    { (yyval.type_node) = new_parent_node("TypeIdList", GROUP_7 + 13, 0); }
...
#line 231 "./syntax.y" /* yacc.c:1646  */
    { (yyval.type_node) = new_parent_node("Specifier", GROUP_8 + 3, 1, (yyvsp[0].type_node)); }
...
#line 249 "./syntax.y" /* yacc.c:1646  */
    { (yyval.type_node) = new_parent_node("Dec", GROUP_9 + 4, 1, (yyvsp[0].type_node)); }
#line 1909 "./syntax.tab.c" /* yacc.c:1646  */
    break;

  case 60:
#line 250 "./syntax.y" /* yacc.c:1646  */
    { (yyval.type_node) = new_parent_node("Dec", GROUP_9 + 5, 2, (yyvsp[-2].type_node), (yyvsp[0].type_node)); }
#line 1915 "./syntax.tab.c" /* yacc.c:1646  */
    break;

  case 61:
#line 254 "./syntax.y" /* yacc.c:1646  */
    { (yyval.type_node) = new_parent_node("VarDec", GROUP_9 + 6, 1, (yyvsp[0].type_node)); }
